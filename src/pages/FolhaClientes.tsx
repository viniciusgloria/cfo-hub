...
export default function FolhaClientesPage() {
  ...
  const bannerTitle = selectedClientId && selectedClientId !== 'Todos' && selectedClient
    ? `Folha de Clientes - ${selectedClient.nome}`
    : 'Folha de Clientes';
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <select
                ...
                className="px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg text-base font-medium bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 min-w-[300px] focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
              >
      ...
      {filtroCliente === 'Todos' ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Card className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Total Colaboradores</div>
                  <div className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">
            ...
            <Card className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Valor Total Período</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                {(() => {
                  ...
                  return clienteValores.map((item, idx) => (
                    <div key={item.cliente.id} className="space-y-1.5 pb-3 border-b border-gray-100 dark:border-gray-800 last:border-0 last:pb-0">
            ...
            <Card className="p-4">
              ...
              <select
                ...
                className="w-full px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 mb-3"
              >
                ...
                return (
                  <div className="space-y-1.5">
                    ...
                    <div className={`p-2 rounded-lg ${statusNoPrazo ? 'bg-green-50 dark:bg-green-900/20' : 'bg-yellow-50 dark:bg-yellow-900/20'}`}>
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Folhas Processadas no Prazo</span>
                    ...
                    <div className={`p-2 rounded-lg ${statusTempo ? 'bg-blue-50 dark:bg-blue-900/20' : 'bg-orange-50 dark:bg-orange-900/20'}`}>
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Tempo Médio de Fechamento</span>
                    ...
                    <div className={`p-2 rounded-lg ${statusErro ? 'bg-purple-50 dark:bg-purple-900/20' : 'bg-red-50 dark:bg-red-900/20'}`}>
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Taxa de Retrabalho</span>
                ...
                return (
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1.5 text-xs">
                      ...
                      <div className="flex justify-between p-1.5 bg-gray-50 dark:bg-gray-800 rounded">
                        <span className="text-gray-600 dark:text-gray-400">Mês seguinte</span>
                        <span className="font-semibold text-gray-900 dark:text-gray-100">
                          {valorMensal.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}
                        </span>
                      </div>
                  ...
                  return (
                    <>
                      <div className="p-3 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-lg">
                        <div className="text-xs text-gray-600 dark:text-gray-400 mb-1.5">Valor Total</div>
                        <div className="flex items-end justify-between">
                          <div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                          <div className="text-xs text-gray-600 dark:text-gray-400 mb-1">Colaboradores</div>
                          <div className="text-xl font-bold text-gray-900 dark:text-gray-100">
                            {colaboradoresAtual}
                          </div>
                        ...
                        <div className="p-2 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                          <div className="text-xs text-gray-600 dark:text-gray-400 mb-0.5">Ticket Médio</div>
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      {topFuncoes.length > 0 ? topFuncoes.map((funcao, idx) => (
                        <div key={funcao.nome} className="p-2 bg-gray-50 dark:bg-gray-800 rounded-lg">
                          <div className="flex items-center justify-between text-sm">
                            <div className="flex items-center gap-2">
              ...
              {(() => {
                ...
                const alertas = [
                  ...
                  },
                  {
                    ...
                    corBorder: 'border-gray-200 dark:border-gray-700',
                    corTexto: 'text-gray-900 dark:text-gray-100',
                    corQuantidade: 'text-gray-600 dark:text-gray-400',
                    prioridade: 5
                  }
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card className="p-4">
              <div className="text-sm text-gray-600 dark:text-gray-400">Total de Lançamentos</div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-sm text-right font-medium text-green-600 dark:text-green-400">
                        {folha.valorTotal.toLocaleString('pt-BR', {
                          style: 'currency',
                          currency: 'BRL'
                        })}
                      </td>
