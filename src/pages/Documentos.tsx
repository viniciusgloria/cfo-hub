      ...
      {viewMode === 'grid' ? (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
          ...
          {pastasVisiveis.map((pasta) => (
            <div
              key={pasta.id}
              className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer group"
            ...
            <tbody>
              {pastasVisiveis.map((pasta) => (
                ...
                >
                  ...
                  <td className="p-3 text-sm text-gray-600 dark:text-gray-400">Pasta</td>
              ...
              {documentosVisiveis.map((doc) => (
                ...
                >
                  ...
                  <td className="p-3 text-sm text-gray-600 dark:text-gray-400">{doc.tipo}</td>
                  <td className="p-3 text-sm text-gray-600 dark:text-gray-400">{formatBytes(doc.tamanho)}</td>
                  <td className="p-3 text-sm text-gray-600 dark:text-gray-400">{doc.colaboradorNome}</td>
                  <td className="p-3 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">{detalhesDoc.tipo}</p>
              </div>
