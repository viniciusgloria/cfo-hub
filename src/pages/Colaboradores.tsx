                  ...
                  {editandoJornada ? (
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                        ...
                        <div>
                          <p className="text-xs text-gray-500 dark:text-gray-400">Fim</p>
                  ...
                  {(() => {
                                ...
                                <div key={p.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-3">
                                  ...
                                  <div className="space-y-2">
                                    {getDocumentosByPasta(p.id).map((d) => (
                                      <div key={d.id} className="flex items-center justify-between p-2 rounded border border-gray-100">
                                        <div className="flex items-center gap-3 min-w-0">
                    ...
                    return (
                      <div className="space-y-3">
                        ...
                        {pastas.length > 0 && (
                          <div>
                            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Pastas</h4>
                          ...
                          >
                            <div className="flex items-start justify-between mb-2">
                              <div className="flex-1">
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{sol.descricao}</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Data: {sol.data}</p>
                              </div>
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="space-y-4">
                        ...
                        <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/20">
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-xs text-gray-600 dark:text-gray-400">Banco de Horas</p>
                        ...
                        <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-xs text-gray-600 dark:text-gray-400">Meta Mensal</p>
