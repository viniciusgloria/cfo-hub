          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    maxLength={14}
                    className={`w-full px-4 py-2 border ${errors.cpf ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-[#10B981] focus:border-transparent`}
                  />
            ...
            <div className="pt-6 border-t border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Digite o CEP para preencher endereço automaticamente (ViaCEP)</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-2 border ${errors.cargoId ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-[#10B981] focus:border-transparent`}
                  >
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className={`w-full pl-10 pr-4 py-2 border ${
                        errors.setorId ? 'border-red-500' : 'border-gray-300'
            ...
            <div className="pt-6 border-t border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">CNPJ (se PJ)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Razão Social (se PJ)</label>
                  <input
                    type="text"
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-4 h-4 text-emerald-600 border-gray-300 rounded focus:ring-2 focus:ring-emerald-400"
                  />
                  <label htmlFor="dispensa" className="text-sm">Dispensar documentação (ativar colaborador sem documentos)</label>
                </div>

                <div>
                  <p className="text-sm text-gray-600 mb-2">Envie documentos iniciais (opcional):</p>
