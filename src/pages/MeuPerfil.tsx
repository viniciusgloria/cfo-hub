        ...
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="text-sm text-gray-600 space-y-1">
              ...
              <p className="text-gray-500 mt-2">A imagem será automaticamente redimensionada e cortada para o formato ideal.</p>
            </div>
          </div>
        </div>
      </Card>
      ...
      <Card>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Nome cadastrado no sistema (não editável)</p>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="usarNomeSocial" className="text-sm font-medium text-gray-700 cursor-pointer">
                Usar nome social
              </label>
            </div>
            {usarNomeSocial && (
