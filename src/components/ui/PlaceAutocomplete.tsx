...
export function PlaceAutocomplete({ value, onChange, onSelect, placeholder, leftIcon }: Props) {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {open && suggestions.length > 0 && (
        <div className="absolute z-50 left-0 right-0 mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded shadow-lg max-h-56 overflow-auto">
          {suggestions.map((s, idx) => (
            <button
              ...
              className={`w-full text-left px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ${highlight === idx ? 'bg-gray-100 dark:bg-gray-700' : ''}`}
            >
