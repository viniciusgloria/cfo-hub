      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="flex gap-3">
            <label className="flex-1">
              ...
              />
                  <div className="p-4 border-2 border-[#374151] rounded-lg cursor-pointer peer-checked:border-[#10B981] transition-all bg-transparent">
                    <p className="font-medium text-gray-800 dark:text-white">Sala de Call</p>
                    <p className="text-xs text-gray-500 dark:text-gray-300">Para videoconferências</p>
                  </div>
            </label>
            <label className="flex-1">
              <input
              ...
              />
              <div className="p-4 border-2 border-[#374151] rounded-lg cursor-pointer peer-checked:border-[#10B981] transition-all bg-transparent">
                <p className="font-medium text-gray-800 dark:text-white">Sala de Reunião</p>
                <p className="text-xs text-gray-500 dark:text-gray-300">Para reuniões presenciais</p>
              </div>
            </label>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 px-4 py-2 border border-gray-300 rounded-lg dark:modal-accent-field`}
            />
          </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className={`w-full px-4 py-2 border border-gray-300 rounded-lg resize-none dark:modal-accent-field`}
          />
