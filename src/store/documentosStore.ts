...
const mockPastas: Pasta[] = [
  {
    id: 'pasta-1',
    nome: 'Documentos Pessoais',
    descricao: 'Documentos de identificação e comprovantes',
    criadoPor: '1',
  ...
  },
  {
    id: 'pasta-2',
    nome: 'Contratos',
    descricao: 'Contratos de trabalho e termos',
    criadoPor: '1',
    criadoPorNome: 'Sistema',
    criadoEm: '2024-01-01T00:00:00Z',
    colaboradorId: 1,
...
const mockDocumentos: Documento[] = [
  {
    id: 'doc-1',
    nome: 'RG - Ana Costa.pdf',
    tipo: 'RG',
    tamanho: 245680,
    dataUpload: '2024-11-15T10:30:00Z',
    uploadPor: '1',
    uploadPorNome: 'Ana Costa',
    colaboradorId: 1,
    ...
    status: 'aprovado',
    statusAlteradoPor: '1',
    statusAlteradoEm: '2024-11-15T14:00:00Z',
    historico: []
  },
  {
    id: 'doc-2',
    nome: 'CPF - Ana Costa.pdf',
    tipo: 'CPF',
    tamanho: 189450,
    dataUpload: '2024-11-15T10:32:00Z',
    uploadPor: '1',
    uploadPorNome: 'Ana Costa',
    colaboradorId: 1,
    colaboradorNome: 'Ana Costa',
  ...
  {
    id: 'doc-3',
    nome: 'Contrato - Ana Costa - 2024.pdf',
    tipo: 'Contrato',
    tamanho: 456789,
    dataUpload: '2024-11-20T09:00:00Z',
    uploadPor: '1',
    uploadPorNome: 'RH',
    colaboradorId: 1,
    colaboradorNome: 'Ana Costa',
  ...
  },
  {
    ...
    tamanho: 312456,
    dataUpload: '2024-12-01T15:20:00Z',
    uploadPor: '2',
    uploadPorNome: 'Bruno Almeida',
    colaboradorId: 2,
    colaboradorNome: 'Bruno Almeida',
    pastaId: 'pasta-3',
    mimetype: 'application/pdf',
    status: 'pendente',
    historico: []
